<x-app-layout>
    <div class="p-6 space-y-6" x-data="{ showModal: false }">
        ...
        <div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Cosechas</h1>
                <p class="text-gray-600">Registra las cosechas realizadas.</p>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white p-6 rounded-xl border shadow-sm flex justify-between items-start">
                <div>
                    <p class="text-sm font-medium text-gray-500">Cosechas</p>
                    <h3 class="text-3xl font-bold text-gray-900 mt-2">{{ $totalCosechas ?? 0 }}</h3>
        ...
        <div class="flex justify-between items-center mt-6">
            <div>
                <h2 class="text-xl font-bold text-gray-900">Lista de Cosechas</h2>
                <p class="text-gray-600">Revisa y gestiona las cosechas registradas.</p>
    </div>
            
        </div>

        <div class="relative">
            <form method="GET" action="{{ route('cosechas.index') }}">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <form action="{{ route('cosechas.destroy', $eval->id) }}" method="POST" onsubmit="return confirm('¿Seguro que deseas eliminar esta evaluación?');" class="inline">
                                @csrf
                                @method('DELETE')
