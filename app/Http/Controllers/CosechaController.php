  ...
  public function index(Request $request)
{
    ...
    $query = Cosechas::where('user_id', $userId)
    ...
    $totalCosechas = (clone $query)->count();
...
public function store(Request $request)
    ...
    return redirect()->back()->with('success', 'Cosecha a sido registrada correctamente');
    }
    public function destroy($id)
    {
        $cosecha = Cosechas::where('user_id', auth()->id())->findOrFail($id);
        $cosecha->delete();
        return redirect()->back()->with('success', 'Cosecha a sido eliminada correctamente.');
    }
